...
impl ::protobuf::Message for Protocol {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new_pb_name::<Protocol>(
                    "Protocol",
                    fields,
    ...
    fn default_instance() -> &'static Protocol {
        static mut instance: ::protobuf::lazy::Lazy<Protocol> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl ::protobuf::Message for NetInt {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new_pb_name::<NetInt>(
                    "NetInt",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static NetInt {
        static mut instance: ::protobuf::lazy::Lazy<NetInt> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl ::protobuf::Message for Init {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new_pb_name::<Init>(
                    "Init",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static Init {
        static mut instance: ::protobuf::lazy::Lazy<Init> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
pub struct MetricMsg {
    ...
    netInt: ::protobuf::SingularField<::std::string::String>,
    netIntId: ::std::option::Option<u32>,
...
impl MetricMsg {
    ...
    pub fn get_netIntId(&self) -> u32 {
        self.netIntId.unwrap_or(0)
    }
    pub fn clear_netIntId(&mut self) {
        self.netIntId = ::std::option::Option::None;
    }

    pub fn has_netIntId(&self) -> bool {
        self.netIntId.is_some()
    }

    // Param is passed by value, moved
    pub fn set_netIntId(&mut self, v: u32) {
        self.netIntId = ::std::option::Option::Some(v);
    }
    ...
    // optional .analysis.MetricAvgMsg metricAvg = 8;
    ...
    // optional .analysis.MetricCumDistrMsg metricCumDistr = 9;
...
impl ::protobuf::Message for MetricMsg {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                3 => {
                    ...
                    let tmp = is.read_uint32()?;
                    self.netIntId = ::std::option::Option::Some(tmp);
                },
                4 => {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_option_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                    "netIntId",
                    |m: &MetricMsg| { &m.netIntId },
                    |m: &mut MetricMsg| { &mut m.netIntId },
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "protocol",
                    |m: &MetricMsg| { &m.protocol },
                    |m: &mut MetricMsg| { &mut m.protocol },
                ));
                fields.push(::protobuf::reflect::accessor::make_option_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                    "protocolId",
                ...
                ::protobuf::reflect::MessageDescriptor::new_pb_name::<MetricMsg>(
                    "MetricMsg",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static MetricMsg {
        static mut instance: ::protobuf::lazy::Lazy<MetricMsg> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl ::protobuf::Message for MetricAvgMsg {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new_pb_name::<MetricAvgMsg>(
                    "MetricAvgMsg",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static MetricAvgMsg {
        static mut instance: ::protobuf::lazy::Lazy<MetricAvgMsg> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl ::protobuf::Message for Freq {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new_pb_name::<Freq>(
                    "Freq",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static Freq {
        static mut instance: ::protobuf::lazy::Lazy<Freq> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl ::protobuf::Message for MetricCumDistrMsg {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new_pb_name::<MetricCumDistrMsg>(
                    "MetricCumDistrMsg",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static MetricCumDistrMsg {
        static mut instance: ::protobuf::lazy::Lazy<MetricCumDistrMsg> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x16\n\x06netInt\x18\x02\x20\x02(\tR\x06netInt\x12\x1a\n\x08netIntId\x18\
    \x03\x20\x02(\rR\x08netIntId\x12\x1a\n\x08protocol\x18\x04\x20\x02(\tR\
    \x08protocol\x12\x1e\n\nprotocolId\x18\x05\x20\x02(\rR\nprotocolId\x12\
    \x12\n\x04time\x18\x06\x20\x02(\x03R\x04time\x12\x1a\n\x08clientId\x18\
    \x07\x20\x02(\x03R\x08clientId\x126\n\tmetricAvg\x18\x08\x20\x01(\x0b2\
    \x16.analysis.MetricAvgMsgH\0R\tmetricAvg\x12E\n\x0emetricCumDistr\x18\t\
    \x20\x01(\x0b2\x1b.analysis.MetricCumDistrMsgH\0R\x0emetricCumDistrB\x08\
    \n\x06values\"D\n\x0cMetricAvgMsg\x12\x10\n\x03avg\x18\x05\x20\x02(\x01R\
    \x03avg\x12\x10\n\x03min\x18\x06\x20\x02(\x01R\x03min\x12\x10\n\x03max\
    \x18\x07\x20\x02(\x01R\x03max\".\n\x04Freq\x12\x12\n\x04name\x18\x01\x20\
    \x02(\tR\x04name\x12\x12\n\x04freq\x18\x02\x20\x02(\x01R\x04freq\"9\n\
    \x11MetricCumDistrMsg\x12$\n\x05freqs\x18\x01\x20\x03(\x0b2\x0e.analysis\
    .FreqR\x05freqs\"\x07\n\x05Close\
";
